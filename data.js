            ...
            'T': {
                'P': {
                    ...
                    'descript': `시간만 있다면 뭐든지! 논리적인 분석가. 
                                ...
                                결정을 내릴 때 잠깐 침묵해요. 하지만 조용하다고 동의의 뜻을 밝힌건 아니니 조금만 더 시간을 주면 좋은 답변을 받을 수 있을거예요! 
...
var questions = [
    ...
    {
        "question": "휴대폰이 요즘따라 왜 이렇게 느리지...?",
        "img": "img/question-img.png",
        "answers": {
            true: {
                "text": "갤럭시나 아이폰처럼 사람들이 많이 쓰는 휴대폰으로 바꾸자!",
                "value": "S"
            },
            false: {
                "text": "평범한건 싫어! 남들이 안쓰는걸로 바꿔야지 ㅎㅎ",
                "value": "N"
            }
        }
    },
